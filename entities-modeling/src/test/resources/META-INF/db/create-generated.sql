...
create table PostComment (id int8 not null, commentDate timestamp, content varchar(2000) not null, post_id int8, primary key (id))
...
create table Tag (id int8 not null, name varchar(20) not null, primary key (id))
